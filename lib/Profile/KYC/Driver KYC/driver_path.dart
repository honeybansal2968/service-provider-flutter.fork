import 'package:authentication/Profile/KYC/Driver%20KYC/driver_page1.dart';
...
class DriverKYCPath extends StatefulWidget {
  @override
  _DriverKYCPathState createState() => _DriverKYCPathState();
}

class _DriverKYCPathState extends State<DriverKYCPath>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: const [
          Center(child: DriverPage1()),
          Center(child: DriverPage2()),
          Center(child: DriverPage3()),
          Center(child: DriverPage4()),
        ],
      ),
    );
  }

...
class TicketUnderProcess extends StatefulWidget {
  const TicketUnderProcess({Key? key}) : super(key: key);

  @override
  State<TicketUnderProcess> createState() => _TicketUnderProcessState();
}
...
class _TicketUnderProcessState extends State<TicketUnderProcess> {
  @override

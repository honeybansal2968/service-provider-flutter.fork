...
class ProviderTogglePage extends StatefulWidget {
  ProviderTogglePage({super.key});

  @override
  State<ProviderTogglePage> createState() => _ProviderTogglePageState();
}

class _ProviderTogglePageState extends State<ProviderTogglePage> {
